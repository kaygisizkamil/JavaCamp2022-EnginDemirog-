...
public class FrameworksController {
	...
	public void add(CreateFrameworkRequest createLanguages) {
		this.frameworkService.add(createLanguages);
	}
	@PutMapping("/frameworks/update/{id}")
	public void update(@RequestBody UpdateFrameworkRequest updateFramework,@PathVariable int id) {
		this.frameworkService.update(updateFramework, id);
		
	}
	@DeleteMapping("/frameworks/delete/{id}")
	public void delete(@RequestBody DeleteFrameworkRequest deleteFramework,@PathVariable int id) {
